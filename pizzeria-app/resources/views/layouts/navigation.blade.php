            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <img src="https://cdn-icons-png.flaticon.com/512/3595/3595455.png" alt="Logo Pizzería" class="h-8 w-8"> {{-- 👈 Tamaño ajustado aquí --}}
                        <span class="ml-2 text-lg font-bold tracking-wider">PizzeríaApp</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('employees.index')" :active="request()->routeIs('employees.index')" class="text-white hover:text-yellow-300">
                        💻 {{ __('Empleados') }}
                        </x-nav-link>
                </div>
